...
func TestReassignNoCandidate(t *testing.T) {
	...
	// все кандидаты неактивны кроме u2
	team := `{
		"team_name": "t9",
		"members":[
